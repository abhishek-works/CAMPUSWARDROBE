...
async function main() {
  ...
  // High-aesthetic fashion photography
  const imgSuit = [
    "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=1000&fit=crop&q=85",
    "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1000&fit=crop&q=85",
  ];
  const imgHoodie = [
    "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=1000&fit=crop&q=85",
    "https://images.unsplash.com/photo-1578587018452-892bacefd3f2?w=1000&fit=crop&q=85",
  ];
  const imgDenim = [
    "https://images.unsplash.com/photo-1576995853123-5a10305d93c0?w=1000&fit=crop&q=85",
    "https://images.unsplash.com/photo-1551537482-f2075a1d41f2?w=1000&fit=crop&q=85",
  ];
  const imgLehenga = [
    "https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=1000&fit=crop&q=85",
    "https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=1000&fit=crop&q=85",
  ];
  const imgKurta = [
    "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=1000&fit=crop&q=85",
    "https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?w=1000&fit=crop&q=85",
  ];
  const imgShirt = [
    "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=1000&fit=crop&q=85",
    "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=1000&fit=crop&q=85",
  ];
  const imgJeans = [
    "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=1000&fit=crop&q=85",
    "https://images.unsplash.com/photo-1582552938357-32b906df40cb?w=1000&fit=crop&q=85",
  ];
  const imgPartyBlazer = [
    "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1000&fit=crop&q=85",
    "https://images.unsplash.com/photo-1593032465175-481ac7f401a0?w=1000&fit=crop&q=85",
  ];
  ...
  const qrToken2 = crypto.randomBytes(24).toString("hex");
